...
after install blender go to edit > preferences and go to addon, download blender.py and press install (import the blender_Addon.py) and enable the Rbx animation
...
setelah menginstal blender, buka edit> preferensi dan buka addon, unduh blender.py dan tekan instal (impor blender_addon.py) dan aktifkan animasi Rbx
